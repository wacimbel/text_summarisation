...
class SummarizationModel(object):
  ...
  def _add_decoder(self, inputs):
    """Add attention decoder to the graph. In train or mode, you call this once to get output on ALL steps. In decode (beam search) mode, you call this once for EACH decoder step.
